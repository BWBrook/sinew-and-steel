...
- **Character voice.** Given a clear frame, it can keep an NPC's manner, grievance, and appetite in view.
- **Availability.** It will run a scene at midnight, after work, or in the small gap where a human table is unavailable.
