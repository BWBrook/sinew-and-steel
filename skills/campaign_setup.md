...
1. Initialize a campaign:
   `uv run python tools/campaign_init.py --title "My Campaign" --skin <skin>`
2. (Optional) Generate a starting character:
   `uv run python tools/campaign_init.py --title "My Campaign" --skin <skin> --random-character "Name"`
