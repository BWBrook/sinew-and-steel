...
Keep prose lean. Think hard-boiled noir on Olympus Mons: dust devils along the mag-rail; jet exhaust etching rust into the sky.
...
![](../assets/art/ss_rust_domes_audit_stamp.png){.wrap-right width=1.5in}

Reliable Controller moves:

- life-support warning,
- rail-cannon test quake,
