...
## Free Trader's Handbook (Adventurer-facing rules)
...
| Intellect | **Education (EDU)** | astrogation, engineering, medicine, xenolinguistics |
...
When the Custodian calls for blind chance, they say: **"Test your Fate."** Roll under your **current credits** (not your maximum).
...
## Trade and port calls (keep it fast)
...
### Patron jobs (default structure)

Offer 2-3 jobs. Each job should state:

- payment (Ship Shares / Debt clearance),
- risk (what clocks tick on failure),
- the catch: legal, moral, or logistical.
...
## Guildmaster's Protocols (Custodian-facing rules)
...
Treat each ship as an NPC with:

- **Pilot score** (usually 10-14).
- **Hull Damage clock (0/6)**, or larger for bigger hulls.
- **Screens soak** (1 civilian, 2 military).
...
- one support crewmate is wounded and needs treatment,
- one support crewmate is killed,
- one support crewmate is missing and becomes a later complication,
