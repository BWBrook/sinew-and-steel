...
If you want a more capable party, raise build points (standard **6** or pulp **12**) without changing any other rules.
...
- **Herbal poultice.** The healer loses **1 STM**, then tests **LOR**.
  - Success: restore **+1 STM** to another (up to max).
...
- **Clues are never gated by rolls.** A test decides clarity, speed, and cost — not whether the clue exists.
  ...
  - Failure: you still get a clue, but you pay (mark **Sin**, tick a clock, lose **STM**, draw suspicion).
...
|3|Official censure|The Abbot (or your Prior) forbids inquiry. Any **test** you make in open defiance costs: **spend 1 PRV bead** (a Providence token) *before rolling*, or mark **+1 Sin**.|
...
**Textures**  
1 frost‑cracked stone • 2 slick candle wax • 3 rough hemp rope • 4 vellum slick with sweat  
